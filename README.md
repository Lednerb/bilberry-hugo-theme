...
If you want to add [MathJAX](https://github.com/rabarar/bilberry-hugo-theme.git) markup support, set parameter `enable_mathjax` option to `true` in our site's config file.
