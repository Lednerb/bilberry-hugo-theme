...
.setResourceRoot('./')
// Moment.js is large enough, thus we create variants
// that can be used with or without Moment.js!
.js(['assets/js/theme.js'], './theme-exclude-moment.js')
.js(['assets/js/theme.js', 'assets/js/moment.js'], './theme.js')
